...
if __name__ == '__main__':
    ...
    while n_sampling > 0:
        ...
        for train_ix, test_ix in tqdm(kfold.split(y)):
            ...
            X_train = tf.keras.preprocessing.sequence.pad_sequences(list_tokenized_train, maxlen=args_lstm.max_seq_len, dtype='float64')
            X_test = tf.keras.preprocessing.sequence.pad_sequences(list_tokenized_test, maxlen=args_lstm.max_seq_len, dtype='float64')
